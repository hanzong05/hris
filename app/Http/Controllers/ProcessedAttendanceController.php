    ...
    public function list(Request $request)
{
    try {
        ...
        // Format the datetime fields for each record
        foreach ($processedData as &$attendance) {
            // Format time values to 12-hour format
            $attendance->time_in = $attendance->time_in ? $attendance->time_in->format('h:i A') : null;
            $attendance->time_out = $attendance->time_out ? $attendance->time_out->format('h:i A') : null;
            $attendance->break_in = $attendance->break_in ? $attendance->break_in->format('h:i A') : null;
            $attendance->break_out = $attendance->break_out ? $attendance->break_out->format('h:i A') : null;
            $attendance->next_day_timeout = $attendance->next_day_timeout ? $attendance->next_day_timeout->format('h:i A') : null;
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $attendance->update([
                ...
                'is_nightshift' => $request->is_nightshift,
