...
const EventList = ({ events, onEdit, onDelete, onView, onMarkCompleted, onMarkCancelled, onMarkScheduled }) => {
if (!events) {
            ...
            <div className="flex space-x-2">
                ...
                {(event.status === 'Cancelled' || event.status === 'Postponed') && (
                    <Button 
                        ...
                        onClick={() => onMarkScheduled(event.id)}
...
const handleMarkCompleted = (id) => {
    setConfirmModal({
        ...
        onConfirm: () => {
            router.post(`/events/${id}/update-status`, {
                status: 'Completed'
            }, {
                preserveState: true,
                preserveScroll: true,
